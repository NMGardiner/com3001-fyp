...
void sparkle_ref(uint32_t *state, int brans, int steps)
{
...
void sparkle_inv_ref(uint32_t *state, int brans, int steps)
{
  int i, j;  // Step and branch counter
...
void clear_state_ref(uint32_t *state, int brans)
{
  int i;
...
void print_state_ref(const uint32_t *state, int brans)
{
